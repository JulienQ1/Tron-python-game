...
def user_login (server_socket,process_index):
...
while True:
    ...
    process1 = multiprocessing.Process(target=user_login, args=(server_socket, 1))
    process2 = multiprocessing.Process(target=user_login, args=(server_socket, 2))
    process3 = multiprocessing.Process(target=user_login, args=(server_socket, 3))
    process4 = multiprocessing.Process(target=user_login, args=(server_socket, 4))
